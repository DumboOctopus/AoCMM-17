...
#remove all congloms:
c.execute("DELETE FROM person_data where is_conglom=1")

c.execute("SELECT person, text_id, typing_data from person_data")
...
for person, text_id, typing_data in persons_data:
    ...
    c.execute("UPDATE person_data SET probabilities_id={} where person = '{}' and text_id={}".format(probabilities_id, person, text_id))
